...
if [ -f "${DEP_ROOT}/include/libpatchfinder/patch.hpp" ] && ! grep -q '^public:' "${DEP_ROOT}/include/libpatchfinder/patch.hpp"; then
  sed -i '0,/void \*_patch;/s//public:\n            void *_patch;/' "${DEP_ROOT}/include/libpatchfinder/patch.hpp"
fi
